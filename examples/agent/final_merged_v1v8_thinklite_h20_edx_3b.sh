...
# activate_agent: True
export LLM_AS_A_JUDGE_BASE="http://172.22.85.123:18901/v1"
export WORLD_SIZE=1

export SAVE_CHECKPOINT_DIR=/workspace/vla/vlm_model_file/verl_checkpoints_0221_3b
# export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues

BASEDIR=/workspace/vla/DeepEyes-Datasets-47k
...
REF_MODEL_PATH=/workspace/vla/vlm_model_file/Qwen25-VL-3B-Instruct
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.logger=['console','rl_logging_board'] \
    ...
    +trainer.rl_logging_board_dir=${SAVE_CHECKPOINT_DIR}/logs/rl_logging_board_3b \
